...
/**
 * This class represents a strategy for rendering text onto the screen.
 * 
 * @author Jim
 */
public class TextRenderingStrategy {
  ...
  /**
   * The width of the orthographic projection that the text gets rendered onto
   * 
  ...
  /**
   * The height of the orthographic projection that the text gets rendered onto
   * 
